...
const Footer = () => {
    ...
    return (
        <footer className={isDarkMode ? 'bg-gray-900 text-gray-200' : 'bg-emerald-700 text-white'}>
            <div className="container mx-auto px-4 py-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* About */}
                    <div>
                        <h2 className={`text-2xl font-bold mb-4 ${isDarkMode ? 'text-green-400' : 'text-white'}`}>PlantPlanet</h2>
                        <p className="mb-4">Your one-stop destination for all plant care guidelines. Bringing nature into your home since 2020.</p>
                    </div>

                    {/* Contact*/}
                    <div>
                        <h3 className={`text-xl font-semibold mb-4 ${isDarkMode ? 'text-green-400' : 'text-white'}`}>Contact Us</h3>
                    ...
                    {/* Social */}
                    <div>
                        <h3 className={`text-xl font-semibold mb-4 ${isDarkMode ? 'text-green-400' : 'text-white'}`}>Connect With Us</h3>
                        ...
                        {/* small Contact Form */}
                        <form className="mt-4">
                            <h4 className={`text-lg font-medium mb-2 ${isDarkMode ? 'text-green-400' : 'text-white'}`}>Send us a message</h4>
                            <input
                                type="email"
                ...
                {/* Copyright */}
                <div className={`mt-6 pt-6 text-center border-t ${isDarkMode ? 'border-gray-700' : 'border-white'}`}>
